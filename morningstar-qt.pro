...
RESOURCES += \
    src/qt/morningstar.qrc \
    src/qt/morningstarfonts.qrc \
...
macx:TARGET = "MorningStar-Wallet-Qt"
...
exists(morningstar-qt-local.pri) {
    include(morningstar-qt-local.pri)
}
