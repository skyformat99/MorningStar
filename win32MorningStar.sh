...
function reset
{
    ...
    cd morningstar
    echo "*** db-4.8 ***"
    curl -fsSL -o db-4.8.30.NC.tar.gz https://github.com/morningstarmarket/morningstar-prebuilt-libs1/releases/download/base1/db-4.8.30.NC.tar.gz
	curl -fsSL -o db-4.8.30-fix-for-mingw.patch https://github.com/morningstarmarket/morningstar-prebuilt-libs1/raw/master/patches/db-4.8.30-fix-for-mingw.patch
