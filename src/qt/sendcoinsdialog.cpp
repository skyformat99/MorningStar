...
{
    ui->setupUi(this);
    GUIUtil::SetMorningStarFonts(this);
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a MorningStar address:"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid MorningStar address"));
        }
        else
        {
